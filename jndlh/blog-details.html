        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <h2 class="title">حضور صاحب السمو الملك الامير: فيصل بن بندر بن عبدالعزيز ال سعود</h2>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item categories">
                ...
                <h3 class="sidebar-title">فئات</h3>
                <ul class="mt-3">
                  <li><a href="#">العام<span>(25)</span></a></li>
                  <li><a href="#">الحياة <span>(12)</span></a></li>
                  <li><a href="#">السفر <span>(5)</span></a></li>
                  <li><a href="#">الاقتصاد <span>(22)</span></a></li>
                  <li><a href="#">الاخبار <span>(8)</span></a></li>
                  <li><a href="#">التعليم <span>(14)</span></a></li>
                </ul>
              </div><!-- End sidebar categories-->

              <div class="sidebar-item recent-posts">
                <h3 class="sidebar-title">اخر الأخبار</h3>
              ...
              <div class="sidebar-item tags">
                <h3 class="sidebar-title">العلامات</h3>
                <ul class="mt-3">
...
<img src="assets/img/2030 (2).png" alt="">
<p>
السعودية - الرياض <br>
مخرج 24<br><br>
...
<strong>Email:</strong> info@jehat.com<br>
        ...
        <div class="col-lg-2 col-md-6 footer-links">
          ...
          <ul>
            ...
            <li><i class="bi bi-chevron-right"></i> <a href="#">مشاريعنا</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">مجموعتنا</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">الأخبار</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">تواصل معنا</a></li>
          </ul>
        </div>
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          <h4>خدماتنا</h4>
          <ul>
            <li><i class="bi bi-chevron-right"></i> <a href="#">صناعة الاحداث</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">استشارات الاعمال</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">استضافة وادارة الفعاليات</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">الاتصالات التسويقية المتكاملة</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">الضيافة وحلول المناسبات الخاصة</a></li>
            <li><i class="bi bi-chevron-right"></i> <a href="#">تنظيم المعارض</a></li>
          </ul>
        </div>
